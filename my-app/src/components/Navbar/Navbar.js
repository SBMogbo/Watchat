  ...
  return (
      <div className={'container-fluid header'}>
        <div className={'row p-3'}>
          ...
          <div className="col-12 col-sm-3 d-flex justify-content-center p-1">
            <img src="https://static.xx.fbcdn.net/rsrc.php/yD/r/d4ZIVX-5C-b.ico"></img>


          </div>
          {/* Header Center */}
          <div className={'col-12 col-sm-6 d-flex p-1 '}>
          ...
          <div className="col-12 col-sm-3 d-flex justify-content-center p-1 header_input">
